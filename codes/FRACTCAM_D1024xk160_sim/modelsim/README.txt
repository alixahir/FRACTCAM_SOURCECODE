...
#
# Generated by export_simulation on Wed Aug 05 21:20:14 +0500 2020
#
################################################################################
...
switch to the './fractcam_tb.sh' script.

./fractcam_tb.sh -reset_run
...
./fractcam_tb.sh -noclean_files

For more information on the script, please type './fractcam_tb.sh -help'.
